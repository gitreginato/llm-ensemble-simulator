#!/usr/bin/env python3
"""Executa simulacoes rule-based avancadas sem uso de API."""
...
from src.advanced_simulation import ScenarioConfig, build_report
from src.rule_based_simulation import run_scenario_rule_based
...
SCENARIOS = [
    ...
    ScenarioConfig(
        ...
        description=(
            ...
            "Logotipo com cara de performance e cuidado, paleta escura/cromada, tipografia forte, "
            "aplicacao em faixada, banner de rua, posts Instagram, cartao de visita. "
            "Kit essencial: R$ 197. Entrega em 5 dias uteis."
        ),
        price_brl=197.0,
    ...
    ScenarioConfig(
        ...
        description=(
            ...
            "aplicacao em fachada, uniforme, cartao de visita, posts de antes/depois. "
            "Kit essencial R$ 197."
        ),
        price_brl=197.0,
        price_model="one_time",
    ...
    ScenarioConfig(
        ...
        description=(
            "Servico de branding para padarias e confeitarias de bairro. "
    ...
    ScenarioConfig(
        ...
        description=(
            ...
            "aplicada em lona, menu-board, embalagens e redes sociais. Kit essencial R$ 197."
        ),
        price_brl=197.0,
        price_model="one_time",
    ...
    ScenarioConfig(
        ...
        description=(
            ...
            "Visita tecnica diagnostica: R$ 0,20."
        ),
        price_brl=0.20,
        price_model="visit",
        target_segment="oficina",
...
def main():
    ...
    for scenario in SCENARIOS:
        result = run_scenario_rule_based(scenario, seed=42)
    ...
    report_path = OUTPUT_DIR / "RELATORIO-RULE-BASED.md"
